    ...
    return(
      <article className='experience-item'>
        ...
        <fieldset className="fieldset-block">
          <input type="hidden" id={professional.professional_id} name={`Professional[${experience_id}].professional_id`}
                 defaultValue={professional.professional_id} ref={register()} />
