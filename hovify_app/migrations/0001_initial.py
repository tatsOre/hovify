# Generated by Django 2.1 on 2020-10-23 04:51
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('pdf_path', models.FileField(upload_to='')),
                ('preview_path', models.FileField(upload_to='')),
                ('cover_letter', models.FileField(upload_to='')),
                ('csv_data', models.FileField(upload_to='')),
            ],
        ),
        migrations.CreateModel(
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('Location', models.CharField(default='', max_length=45)),
                ('City', models.CharField(blank=True, default='', max_length=45, null=True)),
                ('PhoneNumber', models.CharField(default='', max_length=45, null=True)),
