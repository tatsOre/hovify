...
class TestLinkedinScraper(unittest.TestCase):
    ...
    # new_scraping = LikedinScraper(username="", password="", user_agent='a PI 3')
    # new_scraping = LikedinScraper(username="", password="", user_agent='Firefox')

    def test_valid_url_maria(self):
        """ test an existing linkedin profile """
        user_data = self.new_scraping.get_data("https://www.linkedin.com/in/mariafernandacrespo/")
    ...
    def test_valid_url_juan(self):
        """ test an existing linkedin profile """
        user_data = self.new_scraping.get_data("https://www.linkedin.com/in/juansebastianllanogallego/")
    ...
    def test_valid_url_david(self):
        """ test an existing linkedin profile """
        user_data = self.new_scraping.get_data("https://www.linkedin.com/in/davidorejuela14/")
    ...
    def test_valid_url_nath(self):
        """ test an existing linkedin profile """
        user_data = self.new_scraping.get_data("https://www.linkedin.com/in/nathsotomayor/")
    ...
    def test_valid_url_andy(self):
        """ test an existing linkedin profile """
        user_data = self.new_scraping.get_data("https://www.linkedin.com/in/andresfbayona/")
    ...
    def test_valid_url_tatiana(self):
        """ test an existing linkedin profile """
        user_data = self.new_scraping.get_data("https://www.linkedin.com/in/tatiana-orejuela-08b98225/")
        self.assertEqual(user_data['FirstName'], "Tatiana")
        self.assertEqual(user_data['LastName'], "Orejuela")

    def test_invalid_url(self):
        """ test an existing linkedin profile """
        user_data = self.new_scraping.get_data("https://www.linkedin.com/in/hiimnotreal06/")
